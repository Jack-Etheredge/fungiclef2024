...
def evaluate_experiment(experiment_id):
    ...
    model_path = str(experiment_dir / "model.pth")
    predictions_output_csv_path = str(experiment_dir / "submission_fine_tuned_thresholding.csv")
    predictions_with_unknown_output_csv_path = str(
        experiment_dir / "submission_with_unknowns_fine_tuned_thresholding.csv")
    metrics_output_csv_path = str(experiment_dir / "threshold_scores.csv")
    scores_output_path = str(experiment_dir / "competition_metrics_scores.json")
